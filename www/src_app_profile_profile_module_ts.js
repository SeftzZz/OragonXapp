...
let ProfilePage = (_class = class ProfilePage {
  ...
  getselljaketsUserownedqrcodemp(DocId) {
    var _this37 = this;
    return (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this37.senddata.getselljaketsUserownedqrcodemp(DocId).subscribe(dataSell => {
        _this37.detailJaket = JSON.parse(dataSell);
        _this37.qrcodeJaket = _this37.detailJaket.qrcode;
        _this37.nameJaket = _this37.detailJaket.name;
        _this37.ClaimmedJaket = _this37.detailJaket.Claimmed;
        console.log(_this37.detailJaket);
      }, error => {});
    })();
  }
