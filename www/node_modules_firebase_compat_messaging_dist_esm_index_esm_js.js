"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["node_modules_firebase_compat_messaging_dist_esm_index_esm_js"],{
...
/* harmony import */ var _firebase_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @firebase/component */ 44692);
/* harmony import */ var _firebase_messaging__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @firebase/messaging */ 24557);
/* harmony import */ var _firebase_util__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @firebase/util */ 17748);
/* harmony import */ var _firebase_messaging_sw__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @firebase/messaging/sw */ 74775);
...
function isSwSupported() {
  return (0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.isIndexedDBAvailable)() && 'PushManager' in self && 'Notification' in self && ServiceWorkerRegistration.prototype.hasOwnProperty('showNotification') && PushSubscription.prototype.hasOwnProperty('getKey');
}
class MessagingCompatImpl {
  ...
  getToken(options) {
    ...
    return (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return (0,_firebase_messaging__WEBPACK_IMPORTED_MODULE_3__.getToken)(_this._delegate, options);
    })();
  }
  deleteToken() {
    var _this2 = this;
    return (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return (0,_firebase_messaging__WEBPACK_IMPORTED_MODULE_3__.deleteToken)(_this2._delegate);
    })();
  }
  onMessage(nextOrObserver) {
    return (0,_firebase_messaging__WEBPACK_IMPORTED_MODULE_3__.onMessage)(this._delegate, nextOrObserver);
  }
  onBackgroundMessage(nextOrObserver) {
    return (0,_firebase_messaging_sw__WEBPACK_IMPORTED_MODULE_5__.onBackgroundMessage)(this._delegate, nextOrObserver);
  }
}
...
function registerMessagingCompat() {
  _firebase_app_compat__WEBPACK_IMPORTED_MODULE_1__["default"].INTERNAL.registerComponent(new _firebase_component__WEBPACK_IMPORTED_MODULE_2__.Component('messaging-compat', messagingCompatFactory, "PUBLIC" /* ComponentType.PUBLIC */).setServiceProps(NAMESPACE_EXPORTS));
}
...
_firebase_app_compat__WEBPACK_IMPORTED_MODULE_1__["default"].registerVersion(name, version);
...
/* harmony export */ });
/* harmony import */ var D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 71670);
/* harmony import */ var _firebase_installations__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @firebase/installations */ 37152);
/* harmony import */ var _firebase_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @firebase/component */ 44692);
/* harmony import */ var idb__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! idb */ 71611);
/* harmony import */ var _firebase_util__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @firebase/util */ 17748);
/* harmony import */ var _firebase_app__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @firebase/app */ 98770);
...
function _migrateOldDatabase() {
  _migrateOldDatabase = (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (senderId) {
    ...
    const db = yield (0,idb__WEBPACK_IMPORTED_MODULE_3__.openDB)(OLD_DB_NAME, OLD_DB_VERSION, {
      upgrade: function () {
        var _ref = (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (db, oldVersion, newVersion, upgradeTransaction) {
          var _a;
          if (oldVersion < 2) {
...
function _dbGet() {
  _dbGet = (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies) {
...
function _dbSet() {
  _dbSet = (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies, tokenDetails) {
    const key = getKey(firebaseDependencies);
    const db = yield getDbPromise();
...
function _dbRemove() {
  _dbRemove = (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies) {
    const key = getKey(firebaseDependencies);
    const db = yield getDbPromise();
    const tx = db.transaction(OBJECT_STORE_NAME, 'readwrite');
...
function _requestGetToken() {
  _requestGetToken = (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies, subscriptionOptions) {
...
function _requestUpdateToken() {
  _requestUpdateToken = (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies, tokenDetails) {
    const headers = yield getHeaders(firebaseDependencies);
...
function _requestDeleteToken() {
  _requestDeleteToken = (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies, token) {
    const headers = yield getHeaders(firebaseDependencies);
...
function _getHeaders() {
  _getHeaders = (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* ({
    appConfig,
    installations
  }) {
...
function _getTokenInternal() {
  _getTokenInternal = (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (messaging) {
...
function _deleteTokenInternal() {
  _deleteTokenInternal = (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (messaging) {
    const tokenDetails = yield dbGet(messaging.firebaseDependencies);
    if (tokenDetails) {
      yield requestDeleteToken(messaging.firebaseDependencies, tokenDetails.token);
...
function _updateToken() {
  _updateToken = (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (messaging, tokenDetails) {
    try {
...
function _getNewToken() {
  _getNewToken = (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies, subscriptionOptions) {
...
function _getPushSubscription() {
  _getPushSubscription = (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (swRegistration, vapidKey) {
...
function _stageLog() {
  _stageLog = (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (messaging, internalPayload) {
...
function _onSubChange() {
  _onSubChange = (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (event, messaging) {
    var _a, _b;
    const {
      newSubscription
    } = event;
...
function _onPush() {
  _onPush = (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (event, messaging) {
...
function _onNotificationClick() {
  _onNotificationClick = (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (event) {
    var _a, _b;
...
function _getWindowClient() {
  _getWindowClient = (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (url) {
    const clientList = yield getClientList();
...
function registerMessagingInSw() {
  (0,_firebase_app__WEBPACK_IMPORTED_MODULE_5__._registerComponent)(new _firebase_component__WEBPACK_IMPORTED_MODULE_2__.Component('messaging-sw', SwMessagingFactory, "PUBLIC" /* ComponentType.PUBLIC */));
}
...
function _isSwSupported() {
  _isSwSupported = (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    // firebase-js-sdk/issues/2393 reveals that idb#open in Safari iframe and Firefox private browsing
    // might be prohibited to run. In these contexts, an error would be thrown during the messaging
    // instantiating phase, informing the developers to import/call isSupported for special handling.
    return (0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.isIndexedDBAvailable)() && (yield (0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.validateIndexedDBOpenable)()) && 'PushManager' in self && 'Notification' in self && ServiceWorkerRegistration.prototype.hasOwnProperty('showNotification') && PushSubscription.prototype.hasOwnProperty('getKey');
  });
  return _isSwSupported.apply(this, arguments);
}
 ...
 * @public
 */
function getMessagingInSw(app = (0,_firebase_app__WEBPACK_IMPORTED_MODULE_5__.getApp)()) {
  ...
  return (0,_firebase_app__WEBPACK_IMPORTED_MODULE_5__._getProvider)((0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.getModularInstance)(app), 'messaging-sw').getImmediate();
}
/**
...
/***/ 92042:
/*!**********************************************************************!*\
  !*** ./node_modules/firebase/compat/messaging/dist/esm/index.esm.js ***!
  \**********************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _firebase_messaging_compat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @firebase/messaging-compat */ 74802);


/***/ })

}]);
//# sourceMappingURL=node_modules_firebase_compat_messaging_dist_esm_index_esm_js.js.map