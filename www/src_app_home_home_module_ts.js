...
let HomePage = (_class = class HomePage {
  ...
  addNewAddressmp() {
    var _this27 = this;
    this.senddata.setNewAddressmp(this.globalID, this.getnama, this.getaddress).subscribe( /*#__PURE__*/function () {
