  ...
  pay_cartStore(id_cart, user_uid, addressw, getaddress, color) {
    ...
    return (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this13.senddata.setaddressmp(_this13.globalID, _this13.getaddress).subscribe( /*#__PURE__*/function () {
        var _ref8 = (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (viewdata) {
      ...
      if (_this14.globalID == "WB7qCPQR9BYEDT1BW6nQjLjKqBw1") {
        ...
        if (_this14.bnb_balance * 1 > _this14.price * 1 && _this14.bnb_balance * 1 > _this14.marketp2pdragonFee * 1) {
          _this14.web3js.eth.sendTransaction({
            ...
            var _ref9 = (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (err, transactionHash) {
              if (err) {
                ...
                (0,firebase_messaging__WEBPACK_IMPORTED_MODULE_10__.getToken)(messaging, {
                  ...
                  if (tokenPushNotification) {
                    _this14.senddata.gettokenOwnermp(_this14.marketp2pdragonowner).subscribe( /*#__PURE__*/function () {
                      var _ref10 = (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (dataToken) {
        ...
        (0,firebase_messaging__WEBPACK_IMPORTED_MODULE_10__.getToken)(messaging, {
          ...
          if (tokenPushNotification) {
            _this14.senddata.gettokenOwnermp(_this14.marketp2pdragonowner).subscribe( /*#__PURE__*/function () {
              var _ref12 = (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (dataToken) {
                _this14.tokenNotif = JSON.parse(dataToken);
                // Create Transaction History
                const loading = yield _this14.loadingController.create();
                yield loading.present();
  ...
  pay_secondMarketp2p() {
    ...
    if (this.globalID == "WB7qCPQR9BYEDT1BW6nQjLjKqBw1") {
      this.web3js.eth.sendTransaction({
        ...
        var _ref14 = (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (err, transactionHash) {
          if (err) {
      ...
      (0,firebase_messaging__WEBPACK_IMPORTED_MODULE_10__.getToken)(messaging, {
        ...
        if (tokenPushNotification) {
          this.senddata.gettokenOwnermp(this.marketp2pdragonowner).subscribe( /*#__PURE__*/function () {
            var _ref16 = (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (dataToken) {
              _this15.tokenNotif = JSON.parse(dataToken);
              // Create Transaction History
              const loading = yield _this15.loadingController.create();
              yield loading.present();
  ...
  favorite_item(DocId) {
    ...
    return (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this16.senddata.favoritedmp(_this16.globalID, DocId).subscribe( /*#__PURE__*/function () {
        var _ref17 = (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (data) {
