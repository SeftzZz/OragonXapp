...
/* harmony import */ var _angular_service_worker__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! @angular/service-worker */ 64413);
...
let HomePage = (_class = class HomePage {
    ...
    if (this.used % 20 == 0 && this.used > 0 && this.used % 90 !== 0) {
      ...
      if (prob <= 90 / 100 && this.ritra > 0) {
        ...
        this.fs.collection('Roulette').doc('Oragon').update({
          Ritra: firebase_compat_app__WEBPACK_IMPORTED_MODULE_8__["default"].firestore.FieldValue.increment(-1)
        });
        ...
        this.fs.collection('Roulette').doc('Oragon').update({
          Meru: firebase_compat_app__WEBPACK_IMPORTED_MODULE_8__["default"].firestore.FieldValue.increment(-1)
        });
        ...
        this.fs.collection('Roulette').doc('Oragon').update({
          Feng: firebase_compat_app__WEBPACK_IMPORTED_MODULE_8__["default"].firestore.FieldValue.increment(-1)
        });
        ...
        this.fs.collection('Roulette').doc('Oragon').update({
          Akh: firebase_compat_app__WEBPACK_IMPORTED_MODULE_8__["default"].firestore.FieldValue.increment(-1)
        });
      }
  ...
  rolling() {
    if (this.count_roulette > 0 && this.count_roulette > 0) {
      ...
      this.probability();
      this.fs.collection('Roulette').doc(this.globalID).update({
        Used: firebase_compat_app__WEBPACK_IMPORTED_MODULE_8__["default"].firestore.FieldValue.increment(+1)
      });
    } else {
      this.fs.collection('Roulette').doc(this.globalID).update({
        Count: 0
  ...
  connectAccount() {
    ...
    return (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this8.isLogin == '!') {
        ...
        _this8.web3js = new (web3__WEBPACK_IMPORTED_MODULE_12___default())(_this8.provider); // create web3 instance
  ...
  setstorecart(id_product, user_uid, addressw) {
    ...
    return (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this17.isLogin == '!') {
        ...
        yield loading.present();
        _this17.senddata.setstorecart(id_product, user_uid, addressw).subscribe(data => {
          let setstorecart = data;
          _this17.senddata.getstorecart(_this17.globalID).subscribe(data => {
            _this17.storecart = JSON.parse(data);
            for (let i in _this17.storecart) {
              console.log(_this17.storecart[i].addressw);
              if (_this17.storecart.length == 0) {
                _this17.cartCount = 0;
              } else {
                _this17.cartCount = _this17.storecart.length;
              }
              _this17.cartUID = _this17.globalID;
              _this17.carts = _this17.storecart;
              _this17.cartID = _this17.storecart[i].id_cart;
              _this17.storeID = _this17.storecart[i].product_id;
              // this.cartName = this.storecart[i].nama
              _this17.cartDeskripsi = _this17.storecart[i].deskripsi;
              _this17.cartPrice = _this17.storecart[i].harga;
              _this17.cartQty = _this17.storecart[i].qty_cart;
              let cartPriceBNB = _this17.current_bnb * _this17.cartPrice * _this17.cartQty;
              _this17.cartPriceBNB = cartPriceBNB.toFixed(4);
              _this17.cartImg = _this17.storecart[i].gambar;
            }
          }, error => {});
        }, error => {});
        loading.dismiss();
  ...
  updatestorecart(id_cart, user_uid, addressw, transactionHash) {
    ...
    return (0,D_SeftzZz_PROGRAM_OragonXapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      yield loading.present();
      _this18.senddata.updatestorecartHome(id_cart, user_uid, addressw, transactionHash).subscribe(data => {
    ...
    this.senddata.getsellbattery8Usermp(this.globalID).subscribe(dataSell => {
      ...
      if (this.batteriesHigh.length > 0) {
        ...
        this.fs.collection('Items/' + this.globalID + '/Batteries').doc(this.batteriesHigh[0].DocId).update({
          Amount: firebase_compat_app__WEBPACK_IMPORTED_MODULE_8__["default"].firestore.FieldValue.increment(+1)
        }).then(() => {});
        // }
      } else {
    ...
    this.senddata.getsellfoodUserstoremp(this.globalID).subscribe(dataSell => {
      ...
      if (this.foodsHigh.length > 0) {
        ...
        this.fs.collection('Items/' + this.globalID + '/Foods').doc(this.foodsHigh[0].DocId).update({
          Amount: firebase_compat_app__WEBPACK_IMPORTED_MODULE_8__["default"].firestore.FieldValue.increment(+30)
        }).then(() => {});
      } else {
  ...
  addFood20() {
    ...
    this.senddata.getsellfoodUserstoremp(this.globalID).subscribe(dataSell => {
      ...
      if (this.foodsHigh.length > 0) {
        ...
        this.fs.collection('Items/' + this.globalID + '/Foods').doc(this.foodsHigh[0].DocId).update({
          Amount: firebase_compat_app__WEBPACK_IMPORTED_MODULE_8__["default"].firestore.FieldValue.increment(+20)
        }).then(() => {});
      } else {
  ...
  addFood10() {
    ...
    this.senddata.getsellfoodUserstoremp(this.globalID).subscribe(dataSell => {
      ...
      if (this.foodsHigh.length > 0) {
        ...
        this.fs.collection('Items/' + this.globalID + '/Foods').doc(this.foodsHigh[0].DocId).update({
          Amount: firebase_compat_app__WEBPACK_IMPORTED_MODULE_8__["default"].firestore.FieldValue.increment(+10)
        }).then(() => {});
      } else {
  ...
  type: _angular_fire_auth__WEBPACK_IMPORTED_MODULE_20__.Auth
}, {
  type: _angular_service_worker__WEBPACK_IMPORTED_MODULE_21__.SwPush
}]), _class);
HomePage = (0,tslib__WEBPACK_IMPORTED_MODULE_22__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_23__.Component)({
  selector: 'app-home',
  template: _home_page_html_ngResource__WEBPACK_IMPORTED_MODULE_2__,
  encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_23__.ViewEncapsulation.None,
