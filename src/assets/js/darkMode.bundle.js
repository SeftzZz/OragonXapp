function onLoad() {
  ...
  new(function() {
      function t() {
          ...
          }(this, t), this.storageKey = "theme-preference", this.theme = {
      ...
      return r = t, (n = [{
          ...
          value: function() {
              ...
              window.onload = function() {
                  e.reflectPreference(), document.querySelectorAll(".js-dark-mode-trigger").forEach((function(t) {
          ...
          value: function() {
              var e = this;
              document.firstElementChild.className = "", document.firstElementChild.classList.add(this.theme.value), document.querySelectorAll(".js-dark-mode-trigger").forEach((function(t) {
